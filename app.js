...
// Arrow functions are not recommended for constructors that use 'this'. As they do not work the same way.
...
// It will be the object on which the method is called.
// 2. What is "this" when joe.scopeArrow() is invoked?
// Had to look this up in ChatGPT, Arrow functions do not have their own this binding; instead, they inherit the this value from the enclosing lexical scope.
// 3. Explain why "this" is different when an arrow function is used.
//  I'm still a bit confused on this on gettingt the correct answer as all I mostly know is that `this` does not work with an arrow function. Need a bit more explaination on this. 
